...
const PatientsList = () => {
  ...
  return (
    <div className="rounded-xl border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1" style={{ backgroundColor: 'rgba(255, 255, 255, 0.76)' }}>
      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          <thead style={{ backgroundColor: 'rgba(249, 250, 251, 0.76)' }}>
            <tr>
          ...
          <tbody className="divide-y divide-gray-200" style={{ backgroundColor: 'rgba(255, 255, 255, 0.76)' }}>
